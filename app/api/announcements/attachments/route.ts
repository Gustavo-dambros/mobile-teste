...
import type { AttachmentKind } from "@/components/announcements/types"
import { requireUser } from "@/lib/announcements/server"
import { createAdminClient } from "@/lib/supabase/admin"

// This URL is generated once here and stored permanently on the
// announcement's attachments — never regenerated on read. A 30-day TTL
// meant every attachment silently turned into a broken link a month after
// upload, even though the file was still in Storage. Long-lived instead of
