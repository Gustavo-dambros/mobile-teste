...
import { ArrowLeftIcon, PlusIcon, UserPlusIcon, UsersRoundIcon, SearchIcon } from "lucide-react"
...
export default function BatePapoMobilePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <header className="flex h-15 items-center gap-3 border-b border-border px-4">
        ...
        <h1 className="flex-1 text-base font-semibold">Conversas</h1>
        <Button
          variant="ghost"
          size="icon"
          className="h-8 w-8"
